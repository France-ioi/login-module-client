...
use FranceIOI\LoginModuleClient\PlatformApi\LtiRequestInterface;
...
class Client
{
    ...
    public function getLtiRequestInterface()
    {
        return new LtiRequestInterface(
            $this->options
        );
    }
    ...
    private function validateOptions(array $options)
    {
        ...
        if (!empty($missing)) {
            throw new LoginModuleClientException('Login module not configured properly. Options missed: ' . implode(', ', $missing));
        }
    }
